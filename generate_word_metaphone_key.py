...
from g2p_gen import G2PClass

def generate_metaphone_keys(input_file: str, output_dict_file: str, output_list_file: str):
    """
...
def generate_g2p_list_and_dict(input_file: str, output_dict_file: str, output_list_file: str) -> None:
    """
    登録されている単語のリストを受け取り、metaphone_keyだけのリストと、キーがmetaphone_key、バリューが登録された単語となる辞書型のリストを生成します。
    ...
    word_g2p_list = []
    for word in data:
        g2p_key = G2PClass().generate_g2p(word)
...
if __name__ == '__main__':
    generate_metaphone_keys('./registered_json/word_register.json', './generated_json/word_metaphone_dict.json', './generated_json/word_metaphone_list.json')
    generate_g2p_list_and_dict('./registered_json/word_register.json', './generated_json/word_g2p_dict.json', './generated_json/word_g2p_list.json')
